...
class Letter2Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text = findViewById(R.id.letter2)
        text.startAnimation(anim)

        song = MediaPlayer.create(this, R.raw.alwayslove)
        song.isLooping = true
        song.start()
