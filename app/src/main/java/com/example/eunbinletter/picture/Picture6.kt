...
class Picture6 : AppCompatActivity(), FragmentManager.OnBackStackChangedListener,NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.picture6_flip)

        if (savedInstanceState == null) {
            supportFragmentManager
                .beginTransaction()
                .add(R.id.frameLayout, Picture6_front())
                .commit()
        } else {
    ...
    private fun flipCard() {
        ...
        supportFragmentManager.beginTransaction()
            ...
            // 뒷면으로 바뀜
            .replace(R.id.frameLayout, Picture6_back())
            // 뒤로가기 누르면 앞면을 보여줌
            .addToBackStack(null)
            .commit();
    }
