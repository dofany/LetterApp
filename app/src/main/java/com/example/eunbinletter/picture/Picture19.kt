...
class Picture19 : AppCompatActivity(), FragmentManager.OnBackStackChangedListener,NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.picture19_flip)

        if (savedInstanceState == null) {
            supportFragmentManager
                .beginTransaction()
                .add(R.id.frameLayout, Picture19_front())
                .commit()
        } else {
    ...
    private fun flipCard() {
        ...
        supportFragmentManager.beginTransaction()
            ...
            // 뒷면으로 바뀜
            .replace(R.id.frameLayout, Picture19_back())
            // 뒤로가기 누르면 앞면을 보여줌
            .addToBackStack(null)
            .commit();
    }
